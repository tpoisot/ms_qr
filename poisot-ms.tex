...
associated original dataset), probably owing to the fact that the null model is
...
In a vast majority of the situations, this corresponds to networks having a
...
whether the true modularity, or the realized modularity, is the most relevant
